...
export const quizzes: Quiz[] = [
    ...
    // HTML Intermediate
    {
        ...
        questions: [
            ...
            {
                id: 12,
                question: 'Which HTML5 element is used to embed content from another source?',
            ...
            {
                id: 18,
                question: 'Which attribute is used to specify that an element is not yet, or is no longer, relevant?',
            ...
            {
                id: 22,
                question: 'Which HTML5 element is used to specify independent content in a document?',
            ...
            {
                id: 24,
                question: 'Which attribute is used to specify the base URL for all relative URLs in a document?',
            ...
            {
                id: 28,
                question: 'Which attribute is used to specify that an input field should have autocomplete enabled?',
    ...
    // HTML Advanced
    {
        ...
        questions: [
            {
                id: 1,
                question: 'What is the purpose of the preload attribute in the <link> element?',
                options: [
            ...
            {
                id: 2,
                question: 'Which HTML5 feature allows for client-side storage of complex data?',
                options: [
                    'Web Storage',
                    'IndexedDB',
                    'Cookies',
            ...
            {
                id: 4,
                question: 'Which HTML5 API is used for real-time bidirectional communication?',
                options: [
                    'WebSocket',
                    'Server-Sent Events',
                    'Long Polling',
            ...
            {
                id: 6,
                question: 'Which attribute is used for custom data attributes in HTML5?',
                options: [
                    'data-*',
                    'custom-*',
                    'user-*',
            ...
            {
                id: 7,
                question: 'What is the purpose of the srcset attribute in responsive images?',
                options: [
            ...
            {
                id: 8,
                question: 'Which HTML5 element is used for handling mathematical equations?',
                options: [
                    '<math>',
                    '<equation>',
                    '<formula>',
            ...
            {
                id: 16,
                question: 'Which HTML5 element is used for bidirectional text isolation?',
                options: [
                    '<bdi>',
                    '<dir>',
                    '<bdo>',
            ...
            {
                id: 30,
                question: 'Which HTML5 API is used for accessing device camera and microphone?',
                options: [
                    'Media API',
                    'MediaDevices API',
                    'Camera API',
    ...
    // CSS Intermediate
    {
        ...
        questions: [
            ...
            {
                id: 4,
                question: 'How do you change the cursor when hovering over an element in CSS?',
            ...
            {
                id: 9,
                question: 'Which CSS property is used to specify the layout of items in a flexbox container?',
    ...
    // CSS Advanced
    {
        ...
        questions: [
            ...
            {
                id: 8,
                question: 'Which CSS property allows you to specify whether an element is resizable by the user?',
    ...
    // JavaScript Intermediate
    {
        ...
        questions: [
            ...
            {
                id: 6,
                question: 'How do you find the number with the highest value of two numbers?',
                options: [
                    'Math.max(x, y)',
                    'top(x, y)',
                    'Math.ceil(x, y)',
            ...
            {
                id: 10,
                question: 'Which method of an Array object adds one or more elements to the end of the array?',
