...
export const quizzes: Quiz[] = [
  ...
  // Express.js Beginner
  {
    ...
    questions: [
      ...
      {
        id: 3,
        question: "What is the correct way to create an Express application?",
        options: [
      ...
      },
      {
        ...
        options: [
          "A combination of HTTP method and URL path that defines an endpoint",
      ...
      {
        id: 6,
        question: "Which HTTP method is used to handle GET requests in Express?",
        options: ["app.get()", "app.GET()", "app.fetch()", "app.retrieve()"],
        correctAnswer: 0,
      },
      {
        id: 7,
        question: "Which HTTP method is used to handle POST requests in Express?",
        options: [
          "app.post()",
          "app.POST()",
          "app.create()",
      ...
      {
        id: 15,
        question: "What is the default port number when using app.listen() without specifying a port?",
        options: [
          "There is no default, you must specify a port",
          "3000",
          "8080",
          "80",
        ],
      ...
      },
      {
        ...
        options: [
          "Add a middleware at the end that handles all unmatched routes",
          "Express handles it automatically",
          "Use app.error(404)",
          "Use res.status(404)",
        ],
        correctAnswer: 0,
      ...
      {
        id: 18,
        question: "How do you set the status code of a response in Express?",
        options: [
          "res.status(code)",
          "res.setStatus(code)",
          "res.code(code)",
      ...
      {
        id: 23,
        question: "What is the purpose of app.get() when used with a setting name?",
        options: [
          "To retrieve application settings",
          "To get route handlers",
          "To get middleware",
      ...
      },
      {
        ...
        options: [
          ...
          "Express handles errors automatically",
          "Use app.error()",
        ],
        correctAnswer: 0,
      },
      ...
      {
        id: 26,
        question: "How do you create a router in Express?",
        options: [
          "express.Router()",
      ...
      {
        id: 27,
        question: "What is the purpose of app.all() in Express?",
        options: [
          "To handle all HTTP methods for a route",
          "To handle all routes",
          "To handle all errors",
          "To handle all middleware",
        ],
        correctAnswer: 0,
      },
      {
        ...
        options: [
          "req.cookies (with cookie-parser middleware)",
          "req.getCookies()",
          "req.cookie",
          "req.cookieData",
        ],
      ...
      {
        id: 29,
        question: "What is the purpose of res.cookie() in Express?",
        options: [
          "To set a cookie in the response",
          "To get a cookie from the request",
          "To delete a cookie",
          "To parse cookies",
        ],
        correctAnswer: 0,
      ...
      {
        id: 30,
        question: "How do you mount a router in Express?",
        options: [
          "app.use('/path', router)",
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          "app.get() handles all methods, app.use() only handles GET",
          "They are identical",
      ...
      {
        id: 4,
        question: "What is the purpose of express.urlencoded() middleware?",
        options: [
      ...
      },
      {
        ...
        options: [
          "Define a function with (req, res, next) parameters",
          "Use app.middleware()",
          "Use express.middleware()",
          "Define a function with (req, res) parameters",
        ],
        correctAnswer: 0,
      },
      {
        id: 6,
        question: "What is the purpose of app.locals in Express?",
        options: [
          "To store application-level variables accessible in templates",
          "To store local variables",
          "To store environment variables",
          "To store route variables",
        ],
        correctAnswer: 0,
      },
      {
        ...
        options: [
          "To store request-specific variables accessible in templates",
          "To store response variables",
          "To store local storage data",
      ...
      },
      {
        ...
        options: [
          "To create route parameter middleware",
      ...
      },
      {
        ...
        options: [
          "res.json() automatically sets Content-Type to application/json, res.send() infers it",
          "res.send() sets JSON type, res.json() doesn't",
          "They are identical",
          "res.json() is for Vue 2, res.send() is for Vue 3",
        ],
        correctAnswer: 0,
      },
      {
      ...
      {
        id: 14,
        question: "What is the difference between app.listen() and server.listen()?",
        options: [
          "app.listen() is a convenience method that calls server.listen()",
          "server.listen() is a convenience method",
          "They are identical",
          "app.listen() is deprecated",
        ],
        correctAnswer: 0,
      },
      {
        ...
        options: [
          "Use try-catch or wrap async functions with error-handling middleware",
          "Express handles async errors automatically",
          "Use app.asyncError()",
          "Use res.catch()",
        ],
        correctAnswer: 0,
      ...
      {
        id: 16,
        question: "What is the purpose of express.Router({ mergeParams: true })?",
        options: [
          "To preserve req.params from parent router",
          "To merge route parameters",
          "To combine routers",
      ...
      {
        id: 17,
        question: "What is the purpose of app.enable() and app.disable()?",
        options: [
          "To enable or disable application settings",
          "To enable or disable routes",
          "To enable or disable middleware",
      ...
      {
        id: 18,
        question: "How do you create route-specific middleware in Express?",
        options: [
          "Pass middleware as additional arguments to route handlers",
          "Use app.routeMiddleware()",
          "Use express.routeMiddleware()",
      ...
      {
        id: 19,
        question: "What is the purpose of res.download() in Express?",
        options: [
      ...
      },
      {
        ...
        options: [
          "To send a file as an HTTP response",
          "To send file data",
          "To upload files",
          "To delete files",
        ],
      ...
      },
      {
        ...
        options: [
          ...
          "Using app.session()",
          "Sessions are built-in to Express",
        ],
        correctAnswer: 0,
      },
      {
        ...
        options: [
          "To create chainable route handlers for a path",
      ...
      },
      {
        ...
        options: [
          "res.send() automatically sets headers and handles content, res.end() just ends the response",
          "res.end() sets headers, res.send() doesn't",
          "They are identical",
          "res.end() is deprecated",
        ],
        correctAnswer: 0,
      },
      {
      ...
      {
        id: 25,
        question: "What is the purpose of app.engine() in Express?",
        options: [
          "To register template engines",
          "To create engines",
      ...
      {
        id: 26,
        question: "What is the difference between req.body and req.query?",
        options: [
          "req.body contains POST/PUT data, req.query contains URL query parameters",
          "req.query contains POST data, req.body contains query parameters",
          "They are identical",
          "req.body is for GET, req.query is for POST",
        ],
        correctAnswer: 0,
      },
      {
        ...
        options: [
          "Create a middleware function that validates tokens or sessions",
          "Use express.auth()",
      ...
      {
        id: 28,
        question: "What is the purpose of express.raw() middleware?",
        options: [
          "To parse raw request bodies as Buffer",
          "To parse raw JSON",
          "To parse raw text",
          "To parse raw HTML",
        ],
      ...
      {
        id: 29,
        question: "What is the purpose of express.text() middleware?",
        options: [
          "To parse request bodies as text",
          "To send text responses",
          "To format text",
          "To validate text",
        ],
        correctAnswer: 0,
      },
      {
        ...
        options: [
          "Using validation middleware like express-validator or joi",
  ...
  // Express.js Advanced
  {
    ...
    questions: [
      {
        id: 1,
        question: "What is the purpose of Express middleware error handling with 4 parameters?",
        options: [
          "To handle errors in middleware (err, req, res, next)",
          "To handle 4 types of errors",
          "To handle errors in 4 routes",
          "To handle errors with 4 status codes",
        ],
        correctAnswer: 0,
      },
      {
        id: 2,
        question: "How do you implement custom error classes in Express?",
        options: [
          "Create custom Error classes and use them in error-handling middleware",
          "Use express.Error()",
          "Use app.createError()",
          "Express doesn't support custom errors",
        ],
        correctAnswer: 0,
      },
      {
        id: 3,
        question: "What is the purpose of app.mountpath in Express?",
        options: [
          "To get the path pattern on which a sub-app was mounted",
          "To set the mount path",
          "To get the file path",
          "To get the route path",
        ],
        correctAnswer: 0,
      },
      {
        id: 4,
        question: "How do you implement request/response compression in Express?",
        options: [
      ...
      {
        id: 5,
        question: "What is the purpose of express-slow-down middleware?",
        options: [
          "To slow down requests after a certain number of requests",
          "To slow down the server",
          "To slow down responses",
          "To slow down middleware execution",
        ],
        correctAnswer: 0,
      },
      {
        id: 6,
        question: "How do you implement database connection pooling in Express?",
        options: [
          "Configure connection pooling in your database driver (e.g., pg, mysql2)",
          "Use express.pool()",
          "Use app.pool()",
      ...
      {
        id: 7,
        question: "What is the purpose of express-validator's validation chain?",
        options: [
          "To chain multiple validation rules together",
          "To validate chains",
          "To create validation chains",
          "To break validation chains",
        ],
        correctAnswer: 0,
      },
      {
        ...
        options: [
          "Using middleware like morgan or winston",
          "Using express.log()",
          "Using app.log()",
          "Logging is built-in",
        ],
      ...
      },
      {
        ...
        options: [
          "To automatically catch errors in async route handlers",
          "To create async errors",
          "To handle async routes",
          "To validate async functions",
        ],
        correctAnswer: 0,
      },
      {
        ...
        options: [
          "Using route prefixes or headers to differentiate versions",
          "Using express.version()",
          "Using app.version()",
      ...
      {
        id: 11,
        question: "What is the purpose of express-ws for WebSocket support?",
        options: [
          "To add WebSocket support to Express applications",
          "To create WebSocket servers",
          "To handle WebSocket connections",
          "To validate WebSocket data",
        ],
        correctAnswer: 0,
      },
      {
        id: 12,
        question: "How do you implement request timeout handling in Express?",
        options: [
          "Using connect-timeout middleware",
          "Using express.timeout()",
          "Using app.timeout()",
      ...
      {
        id: 13,
        question: "What is the purpose of express-request-id middleware?",
        options: [
          "To add unique request IDs for tracing and logging",
          "To get request IDs",
          "To validate request IDs",
      ...
      },
      {
        ...
        options: [
          "Handle SIGTERM/SIGINT signals and close server connections properly",
          "Use express.shutdown()",
          "Use app.shutdown()",
      ...
      {
        id: 15,
        question: "What is the purpose of express-session's store option?",
        options: [
          "To configure where session data is stored (memory, Redis, etc.)",
          "To store session data",
          "To get session store",
          "To validate session store",
        ],
        correctAnswer: 0,
      },
      {
        id: 16,
        question: "How do you implement request sanitization in Express?",
        options: [
          "Using express-validator's sanitization methods",
          "Using express.sanitize()",
          "Using app.sanitize()",
      ...
      {
        id: 17,
        question: "What is the purpose of express-brute for brute force protection?",
        options: [
          "To prevent brute force attacks by rate limiting failed attempts",
          "To brute force passwords",
          "To validate brute force attempts",
          "To log brute force attempts",
        ],
        correctAnswer: 0,
      },
      {
        id: 18,
        question: "How do you implement request queuing in Express?",
        options: [
          "Using middleware like express-queue or custom queue implementation",
          "Using express.queue()",
          "Using app.queue()",
          "Queuing is built-in",
        ],
      ...
      {
        id: 19,
        question: "What is the purpose of express-validator's custom validators?",
        options: [
          "To create custom validation functions",
      ...
      },
      {
        ...
        options: [
          "Using middleware to transform data before/after route handlers",
          "Using express.transform()",
          "Using app.transform()",
      ...
      {
        id: 21,
        question: "What is the purpose of express-cluster for clustering?",
        options: [
          "To run Express app across multiple CPU cores",
          "To cluster servers",
          "To create clusters",
          "To manage clusters",
        ],
      ...
      {
        id: 23,
        question: "What is the purpose of express-prometheus-middleware?",
        options: [
          "To expose Prometheus metrics for monitoring",
          "To create Prometheus servers",
          "To validate Prometheus data",
          "To format Prometheus metrics",
        ],
        correctAnswer: 0,
      },
      {
        id: 24,
        question: "How do you implement request correlation IDs in Express?",
        options: [
          "Using middleware to generate and propagate correlation IDs",
          "Using express.correlation()",
          "Using app.correlation()",
      ...
      {
        id: 25,
        question: "What is the purpose of express-openapi-validator?",
        options: [
          "To validate requests/responses against OpenAPI specifications",
          "To create OpenAPI specs",
          "To validate OpenAPI files",
          "To format OpenAPI data",
        ],
        correctAnswer: 0,
      },
      {
        id: 26,
        question: "How do you implement request caching in Express?",
        options: [
          "Using middleware like apicache or custom caching logic",
          "Using express.cache()",
          "Using app.cache()",
          "Caching is built-in",
        ],
      ...
      {
        id: 27,
        question: "What is the purpose of express-sitemap-xml?",
        options: [
          "To generate XML sitemaps dynamically",
          "To parse sitemaps",
          "To validate sitemaps",
          "To format sitemaps",
        ],
        correctAnswer: 0,
      },
      {
        id: 28,
        question: "How do you implement request/response encryption in Express?",
        options: [
          "Using HTTPS/TLS at the server level, not Express middleware",
          "Using express.encrypt()",
          "Using app.encrypt()",
      ...
      {
        id: 29,
        question: "What is the purpose of express-bunyan-logger?",
        options: [
          "To provide structured logging using Bunyan",
          "To create Bunyan loggers",
          "To validate Bunyan logs",
          "To format Bunyan logs",
        ],
        correctAnswer: 0,
      },
      {
        id: 30,
        question: "How do you implement microservices communication patterns in Express?",
        options: [
          "Using HTTP clients, message queues, or service mesh patterns",
          "Using express.microservice()",
          "Using app.microservice()",
          "Microservices are built-in",
        ],
        correctAnswer: 0,
      },
    ],
  ...
  // NestJS Beginner
  {
    ...
    questions: [
      ...
      {
        id: 2,
        question: "How do you install NestJS CLI globally?",
        options: [
      ...
      {
        id: 3,
        question: "How do you create a new NestJS project?",
        options: [
      ...
      },
      {
        ...
        options: [
          "A class that handles incoming requests and returns responses",
      ...
      },
      {
        ...
        options: [
          "A class decorated with @Module() that organizes related code",
          "A JavaScript module",
          "A TypeScript module",
          "A Node.js module",
        ],
      ...
      {
        id: 7,
        question: "What decorator is used to create a GET endpoint in NestJS?",
        options: ["@Get()", "@GET()", "@get()", "@Route('GET')"],
        correctAnswer: 0,
      },
      {
        id: 8,
        question: "What decorator is used to create a POST endpoint in NestJS?",
        options: ["@Post()", "@POST()", "@post()", "@Route('POST')"],
        correctAnswer: 0,
      },
      {
        id: 9,
        ...
        options: [
          ...
          "A way to inject data",
          "A way to inject files",
          "A way to inject modules",
        ],
        correctAnswer: 0,
      },
      {
        id: 10,
        question: "What decorator is used to inject a dependency in NestJS?",
        options: ["@Inject()", "@Injectable()", "@Dependency()", "@Provide()"],
        correctAnswer: 0,
      },
      {
        id: 11,
        question: "What is the main entry point file in a NestJS application?",
        options: [
          "main.ts",
          "app.ts",
          "index.ts",
      ...
      {
        id: 12,
        question: "What method is used to start a NestJS application?",
        options: [
          "app.listen()",
          "app.start()",
          "app.run()",
      ...
      {
        id: 13,
        question: "What decorator is used to make a class injectable in NestJS?",
        options: [
          "@Injectable()",
          "@Inject()",
          "@Component()",
      ...
      {
        id: 14,
        question: "What is the purpose of the @Controller() decorator?",
        options: [
          "To define a controller class and its base route",
      ...
      {
        id: 15,
        question: "How do you access route parameters in NestJS?",
        options: [
          "Using @Param() decorator",
          "Using @Route() decorator",
          "Using @Path() decorator",
      ...
      {
        id: 16,
        question: "How do you access query parameters in NestJS?",
        options: [
          "Using @Query() decorator",
          "Using @Param() decorator",
          "Using @Request() decorator",
          "Using @QueryParam() decorator",
        ],
        correctAnswer: 0,
      },
      {
        id: 17,
        question: "How do you access the request body in NestJS?",
        options: [
          "Using @Body() decorator",
          "Using @Request() decorator",
          "Using @Payload() decorator",
          "Using @Data() decorator",
        ],
        correctAnswer: 0,
      },
      {
        id: 18,
        question: "What is the purpose of the AppModule in NestJS?",
        options: [
          "The root module that ties together all other modules",
      ...
      {
        id: 19,
        question: "What decorator is used to create a PUT endpoint in NestJS?",
        options: ["@Put()", "@PUT()", "@put()", "@Route('PUT')"],
        correctAnswer: 0,
      },
      {
        id: 20,
        question: "What decorator is used to create a DELETE endpoint in NestJS?",
        options: ["@Delete()", "@DELETE()", "@delete()", "@Route('DELETE')"],
        correctAnswer: 0,
      },
      {
        id: 21,
        question: "What is the purpose of the @Module() decorator?",
        options: [
          "To define a module and its metadata (controllers, providers, imports, exports)",
          "To create a module",
          "To import a module",
          "To export a module",
        ],
      ...
      {
        id: 22,
        question: "How do you return a JSON response in NestJS?",
        options: [
          "Return an object or use @Res() decorator",
          "Use res.json()",
          "Use return JSON",
          "Use @Json() decorator",
        ],
      ...
      },
      {
        ...
        options: [
          "To list services that can be injected into controllers or other providers",
          "To provide data",
          "To provide routes",
          "To provide modules",
        ],
      ...
      },
      {
        ...
        options: [
          "To list controllers that belong to the module",
      ...
      {
        id: 25,
        question: "How do you set the HTTP status code in NestJS?",
        options: [
          "Using @HttpCode() decorator or HttpStatus enum",
          "Using res.status()",
          "Using @Status() decorator",
          "Using status() method",
        ],
        correctAnswer: 0,
      },
      {
        id: 26,
        question: "What is the purpose of the @Request() decorator in NestJS?",
        options: [
          "To access the underlying Express request object",
          "To make a request",
          "To handle requests",
          "To validate requests",
        ],
      ...
      },
      {
        ...
        options: [
          "A provider class that contains business logic",
          "A web service",
          "A REST service",
          "A database service",
        ],
      ...
      {
        id: 28,
        question: "How do you inject a service into a controller in NestJS?",
        options: [
      ...
      {
        id: 29,
        question: "What is the purpose of the imports array in @Module()?",
        options: [
          "To import other modules that this module depends on",
          "To import services",
      ...
      {
        id: 30,
        question: "What is the purpose of the exports array in @Module()?",
        options: [
          "To export providers that can be used by other modules",
          "To export controllers",
          "To export routes",
          "To export services",
        ],
        correctAnswer: 0,
    ...
    questions: [
      {
        ...
        options: [
          "A class that determines whether a request should be handled by the route handler",
          "A security guard",
          "A route guard",
          "A module guard",
        ],
      ...
      },
      {
        ...
        options: [
          "A class that intercepts requests/responses to add extra logic",
      ...
      {
        id: 4,
        question: "What is the purpose of @UseGuards() decorator?",
        options: [
          "To apply guards to controllers or route handlers",
          "To create guards",
          "To import guards",
          "To export guards",
        ],
      ...
      {
        id: 5,
        question: "What is the purpose of @UseInterceptors() decorator?",
        options: [
          "To apply interceptors to controllers or route handlers",
          "To create interceptors",
          "To import interceptors",
          "To export interceptors",
        ],
        correctAnswer: 0,
      },
      {
        id: 6,
        question: "What is the purpose of @UsePipes() decorator?",
        options: [
          "To apply pipes to controllers or route handlers",
          "To create pipes",
          "To import pipes",
          "To export pipes",
        ],
      ...
      },
      {
        ...
        options: [
          "To automatically validate incoming data using class-validator",
          "To validate responses",
          "To validate modules",
          "To validate services",
        ],
        correctAnswer: 0,
      },
      {
        id: 8,
        question: "What is a DTO (Data Transfer Object) in NestJS?",
        options: [
          "A class that defines the shape of data for validation and transformation",
          "A data object",
          "A transfer object",
          "A data class",
        ],
      ...
      {
        id: 9,
        question: "What is the purpose of @Injectable() with scope options?",
        options: [
          "To control the lifecycle and scope of provider instances",
          "To inject services",
          "To create services",
          "To export services",
        ],
      ...
      {
        id: 10,
        question: "What is a Custom Provider in NestJS?",
        options: [
          "A provider defined with custom logic using useValue, useFactory, or useClass",
          "A custom service",
          "A custom controller",
          "A custom module",
        ],
      ...
      {
        id: 11,
        question: "What is the purpose of @Global() decorator?",
        options: [
          "To make a module available globally without importing it",
          "To create global variables",
          "To create global services",
          "To create global controllers",
        ],
        correctAnswer: 0,
      },
      {
        ...
        options: [
          "To attach custom metadata to route handlers",
          "To set metadata",
          "To get metadata",
          "To delete metadata",
        ],
      ...
      {
        id: 13,
        question: "What is the purpose of @ReflectMetadata() decorator?",
        options: [
          "To attach metadata to classes, methods, or properties",
          "To reflect metadata",
          "To get metadata",
          "To delete metadata",
        ],
      ...
      {
        id: 14,
        question: "What is the purpose of @Headers() decorator?",
        options: [
          "To extract specific request headers",
          "To set headers",
          "To get all headers",
          "To delete headers",
        ],
      ...
      {
        id: 15,
        question: "What is the purpose of @Ip() decorator?",
        options: [
          "To extract the client IP address from the request",
          "To set IP address",
      ...
      {
        id: 16,
        question: "What is the purpose of @Session() decorator?",
        options: [
          "To extract session data from the request",
          "To create sessions",
      ...
      {
        id: 17,
        question: "What is the purpose of @HostParam() decorator?",
        options: [
          "To extract host parameters from the request",
          "To set host parameters",
          "To validate host parameters",
          "To get host name",
        ],
        correctAnswer: 0,
      },
      {
        ...
        options: [
          "To access the underlying Express response object",
          "To send responses",
          "To create responses",
          "To validate responses",
        ],
      ...
      {
        id: 19,
        question: "What is the purpose of @Next() decorator?",
        options: [
          "To access the Express next function for middleware chaining",
          "To go to next route",
          "To skip current route",
          "To validate next step",
        ],
        correctAnswer: 0,
      },
      {
        id: 20,
        question: "What is the purpose of @Req() decorator?",
        options: [
          "To access the underlying Express request object",
          "To make requests",
          "To create requests",
      ...
      {
        id: 21,
        question: "What is the purpose of @Catch() decorator?",
        options: [
          "To create exception filters for handling specific exceptions",
          "To catch errors",
          "To catch requests",
          "To catch responses",
        ],
      ...
      {
        id: 22,
        question: "What is the purpose of @UseFilters() decorator?",
        options: [
          "To apply exception filters to controllers or route handlers",
          "To create filters",
          "To import filters",
          "To export filters",
        ],
      ...
      {
        id: 23,
        question: "What is the purpose of @Transform() decorator from class-transformer?",
        options: [
          "To transform property values during serialization/deserialization",
          "To transform requests",
          "To transform responses",
          "To transform modules",
        ],
        correctAnswer: 0,
      },
      {
        id: 24,
        question: "What is the purpose of @IsOptional() decorator from class-validator?",
        options: [
          "To mark a property as optional in validation",
          "To make properties optional",
          "To validate optional data",
      ...
      {
        id: 25,
        question: "What is the purpose of @IsNotEmpty() decorator from class-validator?",
        options: [
          "To ensure a property is not empty",
          "To check if property is empty",
          "To make property required",
          "To validate empty values",
        ],
        correctAnswer: 0,
      },
      {
        id: 26,
        question: "What is the purpose of @Type() decorator from class-transformer?",
        options: [
          "To specify the type for transformation",
          "To get type",
          "To set type",
          "To validate type",
        ],
      ...
      {
        id: 27,
        question: "What is the purpose of @Expose() decorator from class-transformer?",
        options: [
          "To include a property in serialization",
      ...
      {
        id: 28,
        question: "What is the purpose of @Exclude() decorator from class-transformer?",
        options: [
      ...
      {
        id: 29,
        question: "What is the purpose of @ApiTags() decorator from @nestjs/swagger?",
        options: [
          "To group endpoints in Swagger documentation",
          "To create API tags",
          "To validate tags",
          "To export tags",
        ],
      ...
      {
        id: 30,
        question: "What is the purpose of @ApiProperty() decorator from @nestjs/swagger?",
        options: [
          "To document properties in Swagger schema",
          "To create API properties",
          "To validate properties",
  ...
  // NestJS Advanced
  {
    ...
    questions: [
      {
        id: 1,
        question: "What is the purpose of Dynamic Modules in NestJS?",
        options: [
          "To create modules that can be configured at runtime",
          "To create dynamic routes",
          "To create dynamic services",
          "To create dynamic controllers",
        ],
        correctAnswer: 0,
      },
      {
        id: 2,
        question: "What is the purpose of ModuleRef in NestJS?",
        options: [
          "To get references to providers dynamically at runtime",
      ...
      {
        id: 3,
        question: "What is the purpose of ExecutionContext in NestJS?",
        options: [
          "To access request context in guards and interceptors",
          "To execute code",
          "To create execution contexts",
          "To manage execution",
        ],
        correctAnswer: 0,
      },
      {
        id: 4,
        question: "What is the purpose of Custom Decorators in NestJS?",
        options: [
          "To create reusable decorators that extract or transform data",
          "To create custom decorators",
          "To validate decorators",
          "To export decorators",
        ],
        correctAnswer: 0,
      },
      {
        id: 5,
        question: "What is the purpose of @nestjs/microservices package?",
        options: [
          "To build microservices with message-based communication",
          "To create microservices",
          "To manage microservices",
          "To validate microservices",
        ],
        correctAnswer: 0,
      },
      {
        id: 6,
        question: "What is the purpose of @MessagePattern() decorator?",
        options: [
          "To define message handlers for microservices",
          "To create message patterns",
      ...
      {
        id: 7,
        question: "What is the purpose of @EventPattern() decorator?",
        options: [
          "To define event handlers for event-based communication",
          "To create event patterns",
          "To validate events",
          "To send events",
        ],
        correctAnswer: 0,
      ...
      {
        id: 8,
        question: "What is the purpose of @nestjs/websockets package?",
        options: [
          "To enable WebSocket support for real-time communication",
          "To create WebSocket servers",
      ...
      {
        id: 9,
        question: "What is the purpose of @WebSocketGateway() decorator?",
        options: [
          "To create a WebSocket gateway for handling connections",
          "To create WebSocket routes",
          "To validate WebSocket connections",
          "To manage WebSocket servers",
        ],
        correctAnswer: 0,
      },
      {
        id: 10,
        question: "What is the purpose of @SubscribeMessage() decorator?",
        options: [
      ...
      {
        id: 11,
        question: "What is the purpose of @nestjs/typeorm integration?",
        options: [
          "To integrate TypeORM for database operations",
          "To create TypeORM modules",
          "To validate TypeORM",
          "To manage TypeORM",
        ],
        correctAnswer: 0,
      ...
      {
        id: 12,
        question: "What is the purpose of @nestjs/mongoose integration?",
        options: [
          "To integrate Mongoose for MongoDB operations",
          "To create Mongoose modules",
      ...
      {
        id: 13,
        question: "What is the purpose of @nestjs/passport integration?",
        options: [
          "To integrate Passport.js for authentication",
          "To create Passport modules",
      ...
      {
        id: 14,
        question: "What is the purpose of @nestjs/jwt package?",
        options: [
          "To handle JWT authentication and token management",
      ...
      {
        id: 15,
        question: "What is the purpose of @nestjs/config package?",
        options: [
          "To manage application configuration and environment variables",
      ...
      {
        id: 16,
        question: "What is the purpose of @nestjs/cache-manager?",
        options: [
          "To provide caching functionality with various cache stores",
          "To create cache managers",
          "To validate cache",
          "To manage cache",
        ],
        correctAnswer: 0,
      ...
      {
        id: 17,
        question: "What is the purpose of @nestjs/bull for queue management?",
        options: [
          "To integrate Bull queue for background job processing",
          "To create queues",
          "To validate queues",
          "To manage queues",
        ],
      ...
      {
        id: 18,
        question: "What is the purpose of @nestjs/schedule for task scheduling?",
        options: [
          "To schedule recurring tasks using cron-like syntax",
          "To create schedules",
      ...
      {
        id: 19,
        question: "What is the purpose of @nestjs/throttler for rate limiting?",
        options: [
          "To implement rate limiting and throttling",
          "To create throttlers",
          "To validate throttling",
      ...
      {
        id: 20,
        question: "What is the purpose of @nestjs/event-emitter?",
        options: [
          "To implement event-driven architecture with event emitters",
          "To create event emitters",
          "To validate events",
          "To manage events",
        ],
        correctAnswer: 0,
      },
      {
        ...
        options: [
          "To listen to events emitted by the event emitter",
          "To create events",
          "To validate events",
          "To send events",
        ],
      ...
      {
        id: 22,
        question: "What is the purpose of @nestjs/terminus for health checks?",
        options: [
          "To implement health check endpoints for monitoring",
      ...
      {
        id: 23,
        question: "What is the purpose of @nestjs/serve-static for static files?",
        options: [
          "To serve static files like images, CSS, and JavaScript",
          "To create static files",
          "To validate static files",
      ...
      {
        id: 24,
        question: "What is the purpose of @nestjs/compression for response compression?",
        options: [
          "To compress HTTP responses using gzip or deflate",
          "To create compression",
          "To validate compression",
          "To manage compression",
        ],
        correctAnswer: 0,
      },
      {
        id: 25,
        question: "What is the purpose of @nestjs/helmet for security headers?",
        options: [
      ...
      {
        id: 26,
        question: "What is the purpose of @nestjs/i18n for internationalization?",
        options: [
          "To provide internationalization and localization support",
          "To create i18n",
          "To validate i18n",
          "To manage i18n",
        ],
      ...
      {
        id: 27,
        question: "What is the purpose of @nestjs/elasticsearch integration?",
        options: [
          "To integrate Elasticsearch for search functionality",
          "To create Elasticsearch",
          "To validate Elasticsearch",
          "To manage Elasticsearch",
        ],
        correctAnswer: 0,
      },
      {
        id: 28,
        question: "What is the purpose of @nestjs/graphql for GraphQL support?",
        options: [
          "To build GraphQL APIs with code-first or schema-first approach",
          "To create GraphQL",
          "To validate GraphQL",
          "To manage GraphQL",
        ],
      ...
      {
        id: 29,
        question: "What is the purpose of @nestjs/bullmq for advanced queue management?",
        options: [
          "To use BullMQ for distributed job processing",
          "To create BullMQ queues",
          "To validate BullMQ",
          "To manage BullMQ",
        ],
        correctAnswer: 0,
      ...
      {
        id: 30,
        question: "What is the purpose of @nestjs/axios for HTTP client functionality?",
        options: [
          "To make HTTP requests using Axios with interceptors support",
  ...
  // Vue.js Beginner
  {
    ...
    questions: [
      ...
      },
      {
        id: 2,
        question:
          "Which directive is used to conditionally render an element in Vue?",
        options: ["v-show", "v-if", "v-render", "v-display"],
        correctAnswer: 1,
      },
      {
        id: 3,
        question: "What is the correct syntax for two-way data binding in Vue?",
        options: ["v-bind", "v-model", "v-data", "v-bind:value"],
        correctAnswer: 1,
      },
      {
        id: 4,
        question: "Which directive is used to render a list of items in Vue?",
        options: ["v-list", "v-for", "v-repeat", "v-loop"],
        correctAnswer: 1,
      },
      {
        id: 5,
        question: "What is the correct way to bind an attribute in Vue?",
        options: [
          "v-bind:attribute",
          "v-attribute",
          "v-set:attribute",
      ...
      },
      {
        id: 6,
        question:
          "Which lifecycle hook is called after a component is mounted?",
        options: ["created", "mounted", "beforeMount", "beforeCreate"],
        correctAnswer: 1,
      },
      {
        id: 7,
      ...
      {
        id: 8,
        question: "What is the shorthand syntax for v-on?",
        options: ["@", ":", "#", "&"],
        correctAnswer: 0,
      },
      {
        id: 9,
        question:
          "Which property is used to define reactive data in a Vue component?",
      ...
      },
      {
        ...
        options: [
          "A property that automatically recalculates when its dependencies change",
          "A method that computes values",
          "A property that stores computed results",
          "A function that returns computed data",
        ],
        correctAnswer: 0,
      },
      {
        ...
        options: ["Using props", "Using events", "Using data", "Using methods"],
        correctAnswer: 0,
      },
      {
        id: 12,
        question:
          "How do you emit an event from a child component to a parent component?",
        options: ["$emit", "$send", "$dispatch", "$broadcast"],
        correctAnswer: 0,
      },
      {
        id: 13,
        question:
          "Which directive is used to show or hide an element based on a condition?",
        options: ["v-if", "v-show", "v-hide", "v-display"],
        correctAnswer: 1,
      },
      {
        id: 14,
        ...
        options: [
          "v-if removes the element from DOM, v-show toggles CSS display",
          "v-if toggles CSS display, v-show removes from DOM",
          "They are identical",
          "v-if is for conditions, v-show is for loops",
        ],
        correctAnswer: 0,
      },
      {
        id: 15,
        question: "What is the root element in a Vue component template?",
        options: [
      ...
      {
        id: 16,
        question: "Which method is used to create a new Vue instance?",
      ...
      },
      {
        ...
        options: [
          "To help Vue track each node's identity",
          "To set a unique ID",
          "To sort the list",
          "To filter the list",
        ],
      ...
      {
        id: 18,
        question: "Which directive is used to bind HTML classes conditionally?",
        options: ["v-class", "v-bind:class", "v-css", "v-style"],
        correctAnswer: 1,
      },
      {
        id: 19,
        ...
        options: [
          "A function that watches for changes in data properties",
          "A component that watches other components",
          "A method that watches events",
          "A property that watches computed values",
        ],
        correctAnswer: 0,
      },
      {
        id: 20,
        question:
          "Which lifecycle hook is called before a component is destroyed?",
        options: ["beforeDestroy", "destroyed", "beforeUnmount", "unmounted"],
        correctAnswer: 0,
      },
      {
        id: 21,
        question: "What is the correct way to handle a click event in Vue?",
        options: [
          "v-on:click='methodName'",
          "v-click='methodName'",
          "onclick='methodName'",
          "v-event:click='methodName'",
        ],
        correctAnswer: 0,
      },
      {
        id: 22,
        question: "What does the ref attribute do in Vue?",
        options: [
          "It provides a reference to a DOM element or child component",
          "It creates a reference to a method",
          "It references a computed property",
          "It creates a reference to a prop",
        ],
        correctAnswer: 0,
      },
      {
        id: 23,
        question: "Which directive is used to bind inline styles?",
        options: ["v-style", "v-bind:style", "v-css", "v-inline"],
        correctAnswer: 1,
      },
      {
        id: 24,
        question: "What is the purpose of filters in Vue?",
        options: [
          "To format text in templates (deprecated in Vue 3)",
          "To filter arrays",
      ...
      {
        id: 25,
        question: "What is the correct syntax for a v-for loop with an index?",
        options: [
          "v-for='(item, index) in items'",
          "v-for='item, index in items'",
          "v-for='item in items with index'",
          "v-for='item[index] in items'",
        ],
        correctAnswer: 0,
      },
      {
        id: 26,
        question:
          "Which property is used to define methods in a Vue component?",
      ...
      },
      {
        id: 27,
        question:
          "What is the correct way to access data properties in a Vue template?",
        options: [
      ...
      },
      {
        ...
        options: [
          "A .vue file containing template, script, and style",
          "A component with only one file",
      ...
      {
        id: 29,
        question: "Which directive prevents the default behavior of an event?",
        options: [
          ".prevent modifier",
          ".stop modifier",
          ".default modifier",
      ...
      {
        id: 30,
        question: "What is the purpose of the v-html directive?",
        options: [
    ...
    questions: [
      {
        ...
        question: "What is the difference between v-if and v-show?",
        options: [
          "v-if conditionally renders elements, v-show toggles CSS display",
          "v-show conditionally renders elements, v-if toggles CSS display",
          "They are identical in functionality",
      ...
      {
        id: 2,
        question: "What is a scoped slot in Vue?",
        options: [
          "A slot that has access to child component data",
          "A slot that is scoped to a specific component",
          "A slot with limited visibility",
          "A slot that cannot be accessed",
        ],
        correctAnswer: 0,
      },
      {
        id: 3,
        question: "What is the provide/inject pattern used for?",
        options: [
          "To pass data from parent to child components",
          "To pass data from ancestor to descendant components without prop drilling",
          "To provide data to all components",
      ...
      },
      {
        ...
        options: [
          "A way to share reusable component options",
          "A way to mix components together",
          "A way to combine templates",
          "A way to merge styles",
        ],
        correctAnswer: 0,
      },
      {
        id: 5,
        question: "What is the purpose of Vue.set() or this.$set()?",
        options: [
          "To set reactive properties on objects",
          "To add reactive properties to objects that weren't present at creation",
          "To update component state",
          "To set component props",
        ],
        correctAnswer: 1,
      },
      {
        ...
        options: [
          "A user-defined directive that can be reused across components",
          "A built-in Vue directive",
          "A directive for custom components",
          "A directive that cannot be modified",
        ],
        correctAnswer: 0,
      },
      {
        id: 7,
        question: "What is the nextTick function used for?",
        options: [
          "To delay execution until the next DOM update cycle",
          "To create timers",
          "To schedule tasks",
          "To handle async operations",
        ],
      ...
      {
        id: 8,
        question: "What is the difference between computed properties and methods?",
        options: [
          "Computed properties are cached, methods are not",
          "Methods are cached, computed properties are not",
          "There is no difference",
          "Computed properties can only be used in templates",
        ],
        correctAnswer: 0,
      },
      {
        id: 9,
        question: "What is a dynamic component in Vue?",
        options: [
          "A component that changes its type dynamically using :is",
          "A component that moves dynamically",
          "A component with dynamic props only",
          "A component that updates automatically",
        ],
        correctAnswer: 0,
      },
      {
        ...
        options: [
          "To cache component instances and preserve their state",
          "To keep components alive forever",
          "To prevent components from being destroyed",
          "To maintain component state in memory",
        ],
        correctAnswer: 0,
      },
      {
        id: 11,
        question: "What is the purpose of Vue filters?",
        options: [
          "To format text in templates (deprecated in Vue 3)",
          "To filter arrays",
          "To filter components",
      ...
      },
      {
        ...
        options: [
          "A function that returns virtual DOM nodes",
          "A function that renders components",
          "A function that creates HTML",
          "A function that displays content",
        ],
        correctAnswer: 0,
      },
      {
        id: 13,
        question: "What is the difference between $refs and $el?",
        options: [
          "$refs references components/elements, $el is the root DOM element",
          "$el references components, $refs is the root element",
          "They are identical",
          "$refs is for Vue 2, $el is for Vue 3",
        ],
        correctAnswer: 0,
      },
      {
        id: 14,
        question: "What is event bus pattern in Vue?",
        options: [
          "A pattern for communication between components using a shared Vue instance",
          "A pattern for handling events",
          "A pattern for event delegation",
          "A pattern for event bubbling",
        ],
        correctAnswer: 0,
      },
      {
        id: 15,
        question: "What is the purpose of Vue.use()?",
        options: [
          "To install Vue plugins",
          "To use Vue components",
          "To use Vue directives",
          "To use Vue filters",
        ],
        correctAnswer: 0,
      },
      {
        id: 16,
        question: "What is a transition component in Vue?",
        options: [
          "A component that applies transition effects when elements enter/leave",
          "A component that transitions between states",
          "A component for CSS transitions only",
          "A component for animations only",
        ],
        correctAnswer: 0,
      },
      {
        id: 17,
        question: "What is the difference between sync modifier and v-model?",
        options: [
          "sync modifier is for two-way binding of props, v-model is for form inputs",
          "v-model is for props, sync is for form inputs",
          "They are identical",
          "sync is deprecated, v-model replaces it",
        ],
        correctAnswer: 0,
      },
      {
        id: 18,
        question: "What is a plugin in Vue?",
        options: [
          "An object with an install method that adds global functionality",
          "A component that can be plugged in",
          "A directive that extends Vue",
          "A mixin for global use",
        ],
        correctAnswer: 0,
      },
      {
        id: 19,
        question: "What is the purpose of Vue.extend()?",
        options: [
          "To create a Vue component constructor",
          "To extend Vue functionality",
          "To extend component props",
          "To extend component methods",
        ],
        correctAnswer: 0,
      },
      {
        id: 20,
        question: "What is a functional component in Vue?",
        options: [
          "A stateless component that is just a function",
          "A component with functions only",
          "A component that cannot have state",
          "A component that returns functions",
        ],
        correctAnswer: 0,
      },
      {
        id: 21,
        question: "What is the purpose of Vue.config.silent?",
        options: [
          "To suppress Vue warnings and errors",
          "To silence component events",
          "To disable console logs",
          "To hide component output",
        ],
        correctAnswer: 0,
      },
      {
        id: 22,
        question: "What is the difference between $attrs and $listeners?",
        options: [
          "$attrs contains non-prop attributes, $listeners contains event listeners",
          "$listeners contains attributes, $attrs contains events",
          "They are identical",
          "$attrs is for Vue 2, $listeners is for Vue 3",
        ],
        correctAnswer: 0,
      },
      {
        id: 23,
        question: "What is a slot scope in Vue?",
        options: [
          "The scope of data available to slot content",
          "A scoped slot that receives data from child component",
      ...
      {
        id: 24,
        question: "What is the purpose of Vue.config.devtools?",
        options: [
          "To enable Vue DevTools browser extension",
      ...
      {
        id: 25,
        question: "What is the difference between $watch and watch option?",
        options: [
          "$watch is programmatic, watch option is declarative",
          "watch option is programmatic, $watch is declarative",
          "They are identical",
          "$watch is for Vue 2, watch is for Vue 3",
        ],
        correctAnswer: 0,
      },
      {
        id: 26,
        question: "What is a transition group in Vue?",
        options: [
          "A component for animating lists of elements",
          "A group of transition components",
          "A component for grouping transitions",
          "A component for transition management",
        ],
        correctAnswer: 0,
      },
      {
        id: 27,
        question: "What is the purpose of Vue.config.performance?",
        options: [
          "To enable performance monitoring in development",
          "To improve performance",
          "To measure component performance",
          "To optimize rendering",
        ],
        correctAnswer: 0,
      },
      {
        id: 28,
        question: "What is a named slot in Vue?",
        options: [
          "A slot with a specific name that can be targeted",
          "A slot that must have a name",
          "A slot that cannot be anonymous",
          "A slot with a unique identifier",
        ],
        correctAnswer: 0,
      },
      {
        id: 29,
        question: "What is the difference between $forceUpdate and $nextTick?",
        options: [
          "$forceUpdate forces re-render, $nextTick waits for next DOM update",
          "$nextTick forces update, $forceUpdate waits for DOM",
          "They are identical",
          "$forceUpdate is for Vue 2, $nextTick is for Vue 3",
        ],
        correctAnswer: 0,
      },
      {
        id: 30,
        question: "What is the purpose of Vue.config.productionTip?",
        options: [
          "To show/hide production tips in the console",
    ...
    questions: [
      {
        ...
        options: [
          "A new way to organize component logic using setup() and reactive functions",
          "A way to compose components together",
          "An API for creating compositions",
          "A method for combining templates",
        ],
        correctAnswer: 0,
      },
      {
        ...
        options: [
          "ref() is for primitives and objects, reactive() is only for objects",
          "reactive() is for primitives, ref() is for objects",
          "They are identical",
          "ref() is for Vue 2, reactive() is for Vue 3",
        ],
        correctAnswer: 0,
      },
      {
        id: 3,
        question: "What is the purpose of the setup() function in Vue 3?",
        options: [
          "To define component logic before the component is created",
          "To set up component props",
          "To initialize component state",
          "To configure component options",
        ],
        correctAnswer: 0,
      },
      {
        id: 4,
        question: "What is a Teleport component in Vue 3?",
        options: [
          "A component that renders content to a different part of the DOM",
          "A component for teleporting data",
          "A component for routing",
          "A component for animations",
        ],
        correctAnswer: 0,
      },
      {
        ...
        options: [
          "A component for handling async component loading with fallback UI",
          "A component for suspenseful animations",
          "A component for error handling",
          "A component for loading states",
        ],
        correctAnswer: 0,
      },
      {
        id: 6,
        question: "What is the difference between watch and watchEffect in Vue 3?",
        options: [
          "watch is explicit about dependencies, watchEffect automatically tracks dependencies",
          "watchEffect is explicit, watch is automatic",
          "They are identical",
          "watch is for Vue 2, watchEffect is for Vue 3",
        ],
        correctAnswer: 0,
      },
      {
        id: 7,
        question: "What is the purpose of defineProps and defineEmits in Vue 3?",
        options: [
          "Compile-time macros for defining component props and emits",
          "Runtime functions for props and emits",
          "Functions for validating props",
      ...
      {
        id: 8,
        question: "What is a Fragment in Vue 3?",
        options: [
          "A component that can have multiple root nodes",
      ...
      },
      {
        ...
        options: [
          "To create a ref that only tracks shallow changes",
          "To create a shallow copy of a ref",
          "To create a ref with shallow depth",
          "To optimize ref performance",
        ],
        correctAnswer: 0,
      },
      {
        ...
        options: [
          "readonly() makes all nested properties readonly, shallowReadonly() only makes top-level readonly",
          "shallowReadonly() makes all nested readonly, readonly() only top-level",
          "They are identical",
          "readonly() is for Vue 2, shallowReadonly() is for Vue 3",
        ],
        correctAnswer: 0,
      },
      {
        id: 11,
        question: "What is the purpose of toRef() and toRefs() in Vue 3?",
        options: [
          "To convert reactive object properties into refs",
          "To convert refs into reactive objects",
      ...
      {
        id: 12,
        question: "What is a custom renderer in Vue 3?",
        options: [
          "A way to customize how Vue renders components to different targets",
          "A custom rendering function",
          "A way to render custom components",
          "A custom template renderer",
        ],
        correctAnswer: 0,
      },
      {
        id: 13,
        question: "What is the purpose of getCurrentInstance() in Vue 3?",
        options: [
          "To access the current component instance in setup()",
          "To get the current Vue instance",
          "To get the current app instance",
          "To get the current router instance",
        ],
        correctAnswer: 0,
      },
      {
        id: 14,
        question: "What is the difference between provide/inject in Options API vs Composition API?",
        options: [
          "Composition API uses provide() and inject() functions, Options API uses provide/inject options",
          "Options API uses functions, Composition API uses options",
          "They are identical",
          "provide/inject is only available in Composition API",
        ],
        correctAnswer: 0,
      },
      {
        id: 15,
        question: "What is the purpose of unref() in Vue 3?",
        options: [
          "To get the value from a ref, returning the value if it's a ref or the value itself if not",
          "To remove a ref",
          "To unregister a ref",
      ...
      {
        id: 16,
        question: "What is Server-Side Rendering (SSR) in Vue?",
        options: [
          "Rendering Vue components on the server to improve initial load time",
          "Rendering components only on the server",
          "A server-side framework for Vue",
          "A way to serve Vue applications",
        ],
        correctAnswer: 0,
      },
      {
        ...
        options: [
          ...
          "To mark an object as raw data",
          "To mark an object for deletion",
          "To mark an object as read-only",
        ],
        correctAnswer: 0,
      },
      {
        id: 18,
        question: "What is the difference between effectScope() and reactive()?",
        options: [
          "effectScope() groups reactive effects, reactive() creates reactive objects",
          "reactive() groups effects, effectScope() creates objects",
          "They are identical",
          "effectScope() is for Vue 2, reactive() is for Vue 3",
        ],
        correctAnswer: 0,
      },
      {
        id: 19,
        question: "What is the purpose of defineAsyncComponent() in Vue 3?",
        options: [
          "To define a component that is loaded asynchronously",
          "To define async component methods",
          "To create async components",
          "To handle async component loading",
        ],
        correctAnswer: 0,
      },
      {
        id: 20,
        question: "What is the difference between v-model in Vue 2 and Vue 3?",
        options: [
          "Vue 3 supports multiple v-models on a single component, Vue 2 supports only one",
          "Vue 2 supports multiple v-models, Vue 3 supports only one",
          "They are identical",
          "v-model is only available in Vue 3",
        ],
        correctAnswer: 0,
      },
      {
        id: 21,
        question: "What is the purpose of defineExpose() in Vue 3?",
        options: [
          "To expose component properties to parent components via template refs",
          "To expose props to child components",
          "To expose methods globally",
          "To expose component state",
        ],
        correctAnswer: 0,
      },
      {
        id: 22,
        question: "What is a custom element in Vue 3?",
        options: [
          "A Vue component that can be used as a custom HTML element",
          "A custom HTML element",
          "A component with custom styling",
          "A component with custom behavior",
        ],
        correctAnswer: 0,
      },
      {
        id: 23,
        question: "What is the purpose of isProxy() and isReactive() in Vue 3?",
        options: [
          "To check if an object is a proxy or reactive",
          "To create proxies and reactive objects",
          "To convert objects to proxies",
          "To validate reactive objects",
        ],
        correctAnswer: 0,
      },
      {
        id: 24,
        question: "What is the difference between computed() and computed() with getter/setter?",
        options: [
          "computed() with getter/setter allows both reading and writing, computed() with function is read-only",
          "computed() with function allows writing, getter/setter is read-only",
          "They are identical",
          "computed() is for Vue 2, getter/setter is for Vue 3",
        ],
        correctAnswer: 0,
      },
      {
        id: 25,
        question: "What is the purpose of nextTick() in Vue 3?",
        options: [
          "To defer execution until after the next DOM update cycle",
      ...
      },
      {
        ...
        options: [
          "Pinia is the recommended state management for Vue 3, Vuex is for Vue 2",
          "Vuex is for Vue 3, Pinia is for Vue 2",
          "They are identical",
          "Pinia replaces Vuex completely",
        ],
        correctAnswer: 0,
      },
      {
        id: 27,
        question: "What is the purpose of withDefaults() in Vue 3?",
        options: [
          "To provide default values for props defined with defineProps",
          "To set default component options",
          "To define default component state",
          "To create default component methods",
        ],
        correctAnswer: 0,
      },
      {
        ...
        options: [
          "onMounted runs after component is mounted, onBeforeMount runs before",
          "onBeforeMount runs after mounting, onMounted runs before",
          "They are identical",
          "onMounted is for Vue 2, onBeforeMount is for Vue 3",
        ],
        correctAnswer: 0,
      },
      {
        id: 29,
        question: "What is the purpose of createApp() in Vue 3?",
        options: [
          "To create a new Vue application instance",
          "To create a new component",
          "To create a new Vue instance",
          "To create app configuration",
        ],
        correctAnswer: 0,
      },
      {
        id: 30,
        question: "What is the difference between Vue 2 and Vue 3 reactivity system?",
        options: [
          "Vue 3 uses Proxy-based reactivity, Vue 2 uses Object.defineProperty",
          "Vue 2 uses Proxy, Vue 3 uses Object.defineProperty",
          "They use the same system",
          "Vue 3 doesn't have reactivity",
        ],
        correctAnswer: 0,
      },
    ],
